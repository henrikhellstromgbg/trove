...
- Slack-pollen fångar nu även trådsvar (`conversations.replies` per trådförälder i fönstret; svaren taggas med `threadTs`). Delade filer fångas fortfarande inte.
